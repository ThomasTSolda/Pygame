...
def jogo():
    ...
    while True:
        ...
        if jogando == True:
            ...
            pixelXMissel = list(range(movimentoX, movimentoX+larguraMissel + 1))

            pixelYNave = list(range(posicaoYNave, posicaoYNave + alturaNave +1 ))
            pixelXNave = list(range(posicaoXNave, posicaoXNave + larguraNave +1 ))
